...
router.get('/', (req,res)=>{
    mysqlCon.query("SELECT match_number, team_number, auto_low, auto_high, tele_op_low, tele_op_high, auto_line, wheel_stage_2, wheel_stage_3, hang, balanced, played_defence FROM match_results;", (err, rows, fields)=>{
        if (err) throw err;
        //console.log(rows); 
